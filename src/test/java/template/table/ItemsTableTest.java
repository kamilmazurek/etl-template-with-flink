...
class ItemsTableTest {
    ...
    @Test
    void shouldInitializeItemsTable() {
        ...
        //when items table is initialized
        new ItemsTable().init(tableEnv);
        ...
        //and code contains information about items table
        assertTrue(code.contains("CREATE TABLE items"));
        assertTrue(code.contains("id STRING"));
        assertTrue(code.contains("name STRING"));
        assertTrue(code.contains("description STRING"));
        ...
        assertTrue(code.contains("'table-name' = 'items'"));
    }
